  ...
  return (
    <div className="login">
     <header className="App-header">
      ...
      <img src={logo} className="App-logo" alt="logo" style={{marginLeft:"18%"}} />
      ...
      <button onClick={signIn} id="login-btn" style={{border: "1 px solid #c49c48", fontFamily:'Lucida Grande',
        fontSize:"1vw", color:"rgb(37, 5, 63)",backgroundColor:"#bcaaa4", borderRadius:"1rem", width: "7vw", height: "6vh"}}>Sign In</button>
      </Item>
      <Item paddingLeft={4} paddingTop={1} fontFamily="Lucida Grande" style={{opacity:"0.8", color:"rgb(49, 7, 83)"}}><h3>or </h3></Item>
      <Item>
        ...
        color:"rgb(37, 5, 63)",backgroundColor:"#bcaaa4", borderRadius:"1rem", width: "14vw", height: "6vh"}}>
          Start a Video Call
        </button>
      </Item>
      </Row>
